  ...
  return (
    <div style={{ minHeight: "100vh", background: "#0A0A0A", color: "#e5e2e1", fontFamily: "'Inter',sans-serif", overflowX: "hidden" }}>
      <style>{`
        ...
        .ln-nav-link { position: relative; cursor: pointer; background: none; border: none; font-family: 'Inter',sans-serif; }
        ...
        <section className="ln-bg-glow" style={{ position: "relative", minHeight: "100vh", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", paddingTop: "128px", paddingBottom: "80px", overflow: "hidden" }}>
          ...
          <div style={{ position: "relative", zIndex: 10, maxWidth: "900px", margin: "0 auto", padding: "0 24px", textAlign: "center", display: "flex", flexDirection: "column", alignItems: "center" }}>
            ...
            <div style={{ display: "flex", flexWrap: "wrap", gap: "20px", justifyContent: "center" }}>
              <button onClick={onGoSignup} className="ln-glow-btn" style={{ background: "#4edea3", color: "#003824", padding: "16px 40px", borderRadius: "12px", fontWeight: 700, fontSize: "17px", border: "none", cursor: "pointer", fontFamily: "'Inter',sans-serif" }}>
                Start Your Journey
              </button>
              <button onClick={onGoLogin} className="ln-glass" style={{ color: "#fff", padding: "16px 40px", borderRadius: "12px", fontWeight: 700, fontSize: "17px", cursor: "pointer", fontFamily: "'Inter',sans-serif", display: "flex", alignItems: "center", gap: "8px" }}>
                🚀 Try Demo
              </button>
            </div>
          </div>
        ...
        <section style={{ padding: "100px 24px" }}>
          <div className="ln-glass" style={{ maxWidth: "1100px", margin: "0 auto", borderRadius: "48px", padding: "60px 32px", textAlign: "center", position: "relative", overflow: "hidden" }}>
            ...
            <div style={{ position: "relative", zIndex: 1 }}>
              ...
              <p style={{ color: "#bbcabf", fontSize: "18px", maxWidth: "560px", margin: "0 auto 40px", lineHeight: 1.6 }}>
                Start tracking your carbon footprint today and join the movement toward a better tomorrow.
              </p>
              <button onClick={onGoSignup} className="ln-glow-btn" style={{ background: "#4edea3", color: "#003824", padding: "20px 48px", borderRadius: "16px", fontWeight: 700, fontSize: "19px", border: "none", cursor: "pointer", fontFamily: "'Inter',sans-serif" }}>
                Get Started Now
              </button>
            </div>
          </div>
